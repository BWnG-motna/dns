...
daniel::dns::RR::SvcParam::SvcParam()
	: key( SvcKey::reserved ) , len( 0 ) , isSet( false )
{
	value[ 0 ] = '\0' ;
}


daniel::dns::RR::SvcParam::SvcParam( uint16_t const & _key , uint8_t const * pDat , uint16_t const & _len )
...
daniel::dns::RR::SvcParam::SvcParam( SvcKey const & _key , uint8_t const * pDat , uint16_t const & _len )
...
bool daniel::dns::RR::SvcParam::IsSet() const
{
	return isSet ;
}


void daniel::dns::RR::SvcParam::UnSet()
{
	isSet = false ;
	key   = SvcKey::reserved ;
	len   = 0 ;
...
void daniel::dns::RR::SvcParam::SetKey( uint16_t const & _key )
{
	key = enumFromUint16< SvcKey >( _key ) ;
}


void daniel::dns::RR::SvcParam::SetKey( SvcKey const & _key )
{
	key = _key ;
}


void daniel::dns::RR::SvcParam::SetValue( uint8_t const * pDat , uint16_t const & _len )
{
	if( nullptr == pDat )
	{
		return ;
...
daniel::dns::RR::SvcKey daniel::dns::RR::SvcParam::GetKey() const
{
	return key ;
}


uint16_t daniel::dns::RR::SvcParam::GetLen() const
{
	return len ;
}


uint8_t const * daniel::dns::RR::SvcParam::GetValue() const
{
	return value ;
}


bool daniel::dns::RR::SvcParam::IsValidValue() const
{
	switch( key )
	{
...
std::string daniel::dns::RR::SvcParam::ToStr() const
{
	std::string str = "" ;
...
std::string daniel::dns::RR::SvcParam::MandatoryToStr() const
{
	std::string str = "" ;
...
std::string daniel::dns::RR::SvcParam::AlpnToStr() const
{
...
std::string daniel::dns::RR::SvcParam::PortToStr() const
{
...
std::string daniel::dns::RR::SvcParam::EchToStr() const
{
...
std::string daniel::dns::RR::SvcParam::Ipv4HintToStr() const
{
...
std::string daniel::dns::RR::SvcParam::Ipv6HintToStr() const
{
