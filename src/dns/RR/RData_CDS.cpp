...
daniel::dns::RR::RData_CDS::RData_CDS()
...
void daniel::dns::RR::RData_CDS::Initialize()
{
	if( nullptr != pDigest )
	{
		delete [] pDigest ;
...
uint16_t daniel::dns::RR::RData_CDS::ToNullStr( uint8_t * pStr , uint16_t const & length ) const
{
...
bool daniel::dns::RR::RData_CDS::Load( uint8_t const * pData , uint16_t const & length )
{
...
uint16_t daniel::dns::RR::RData_CDS::GetKeyTag() const
{
	return keyTag ;
}


daniel::dns::RR::SEC::SECAlgo daniel::dns::RR::RData_CDS::GetAlgorithm() const
{
	return algorithm ;
}


uint16_t daniel::dns::RR::RData_CDS::GetDigestLen() const
{
	return digestLen ;
}


uint8_t const * daniel::dns::RR::RData_CDS::GetDigest() const
{
	return pDigest ;
}