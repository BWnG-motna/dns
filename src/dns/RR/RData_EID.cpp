...
daniel::dns::RR::RData_EID::RData_EID()
...
void daniel::dns::RR::RData_EID::Initialize()
{
	if( nullptr != pBinary )
	{
		delete [] pBinary ;
...
uint16_t daniel::dns::RR::RData_EID::ToNullStr( uint8_t * pStr , uint16_t const & length ) const
{
...
bool daniel::dns::RR::RData_EID::Load( uint8_t const * pData , uint16_t const & length )
{
...
uint16_t daniel::dns::RR::RData_EID::GetLength() const
{
	return binlen ;
}


uint8_t const * daniel::dns::RR::RData_EID::GetBinary() const
{
	return pBinary ;
}