...
void daniel::dns::RR::TypeBitMap::SetBit( uint16_t const & qtype , bool const & _isSet ) 
{
...
bool daniel::dns::RR::TypeBitMap::IsSet() const
{
	return isSet ;
}


uint8_t daniel::dns::RR::TypeBitMap::GetNo() const
{
	return winNo ;
}


uint8_t daniel::dns::RR::TypeBitMap::GetLen() const
{
	return len ;
}


bool daniel::dns::RR::TypeBitMap::GetBit( uint16_t const & qtype ) const
{
	uint8_t no = static_cast< uint8_t >( qtype / 256 ) ;
...
uint8_t daniel::dns::RR::TypeBitMap::GetSetCount() const
{
	return typeCount ;
}


uint16_t const * daniel::dns::RR::TypeBitMap::GetTypes() const
{
	return types ;
}