...
daniel::dns::RR::RData_DLV::RData_DLV()
...
void daniel::dns::RR::RData_DLV::Initialize()
{
	if( nullptr != pDigest )
	{
		delete [] pDigest ;
...
uint16_t daniel::dns::RR::RData_DLV::ToNullStr( uint8_t * pStr , uint16_t const & length ) const
{
...
bool daniel::dns::RR::RData_DLV::Load( uint8_t const * pData , uint16_t const & length )
{
...
uint16_t daniel::dns::RR::RData_DLV::GetKeyTag() const
{
	return keyTag ;
}


daniel::dns::RR::SEC::SECAlgo daniel::dns::RR::RData_DLV::GetAlgorithm() const
{
	return algorithm ;
}


uint16_t daniel::dns::RR::RData_DLV::GetDigestLen() const
{
	return digestLen ;
}


uint8_t const * daniel::dns::RR::RData_DLV::GetDigest() const
{
	return pDigest ;
}