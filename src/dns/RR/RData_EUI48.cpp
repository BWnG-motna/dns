...
daniel::dns::RR::RData_EUI48::RData_EUI48()
	: RData( nullptr )
{
	Initialize() ;
}
...
void daniel::dns::RR::RData_EUI48::Initialize()
{
...
uint16_t daniel::dns::RR::RData_EUI48::ToNullStr( uint8_t * pStr , uint16_t const & length ) const
{
...
bool daniel::dns::RR::RData_EUI48::Load( uint8_t const * pData , uint16_t const & length )
{
...
void daniel::dns::RR::RData_EUI48::GetAddress( uint8_t ( & addr )[ addrMaxLen ] )
{
	for( uint8_t pos = 0 ; pos < addrMaxLen ; ++pos )
	{
