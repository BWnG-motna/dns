...
daniel::dns::RR::RData_TA::RData_TA()
...
void daniel::dns::RR::RData_TA::Initialize()
{
	if( nullptr != pDigest )
	{
		delete [] pDigest ;
...
uint16_t daniel::dns::RR::RData_TA::ToNullStr( uint8_t * pStr , uint16_t const & length ) const
{
...
bool daniel::dns::RR::RData_TA::Load( uint8_t const * pData , uint16_t const & length )
{
...
uint16_t daniel::dns::RR::RData_TA::GetKeyTag() const
{
	return keyTag ;
}


daniel::dns::RR::SEC::SECAlgo daniel::dns::RR::RData_TA::GetAlgorithm() const
{
	return algorithm ;
}


uint16_t daniel::dns::RR::RData_TA::GetDigestLen() const
{
	return digestLen ;
}


uint8_t const * daniel::dns::RR::RData_TA::GetDigest() const
{
	return pDigest ;
}