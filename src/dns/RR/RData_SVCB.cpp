...
daniel::dns::RR::RData_SVCB::~RData_SVCB() 
{
	Initialize() ;
}


void daniel::dns::RR::RData_SVCB::Initialize()
{
...
uint32_t daniel::dns::RR::RData_SVCB::GetParamCount() const
{
	if( nullptr == pParam )
	{
		return 0 ;
