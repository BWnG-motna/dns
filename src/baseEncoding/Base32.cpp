...
daniel::baseEncoding::Base32::Base32()
{

}


bool daniel::baseEncoding::Base32::Encode( 
...
bool daniel::baseEncoding::Base32::Read5Bits( uint8_t & res , uint8_t const * pDat , uint16_t const & datlen , uint32_t const & bitPos )
{
	if( nullptr == pDat || 1 > datlen )
	{
		return false ;
