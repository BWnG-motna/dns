...
daniel::baseEncoding::Base64::Base64()
{

}


bool daniel::baseEncoding::Base64::Encode( 
...
bool daniel::baseEncoding::Base64::Read6Bits( uint8_t & res , uint8_t const * pDat , uint16_t const & datlen , uint32_t const & bitPos )
{
	if( nullptr == pDat || 1 > datlen )
	{
		return false ;
