...
enum class SECAlgo : uint8_t
{
	...
	DH                       =   2 , // RFC 8624 - MUST NOT
	DSA_SHA1                 =   3 , // RFC 8624 - MUST NOT      /  64 bytes
	RSA_SHA1                 =   5 , // RFC 8624 - SHOULD NOT    / 128 bytes
	DSA_NSEC3_SHA1           =   6 , // RFC 8624 - MUST NOT
	...
	GOST_R_34_10_2001        =  12 , // RFC 8624 - NOT RECOMMAND --> RFC 9906 DEPRECATED
	...
	GOST_R_34_10_2012        =  23 , // RFC 8624 - MUST NOT
} ;
